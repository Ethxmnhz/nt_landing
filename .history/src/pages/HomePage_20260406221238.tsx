        ...
        <div className="section-shell">
          <AnimatedSection delay={80}>
            <article className="meet-ishita-centered">
              ...
              <p className="meet-ishita-copy">
                The doctors were kind and also honest. "Manage your expectations," they said. I
                heard them. I chose a different story.
              </p>
              <p className="meet-ishita-copy">
              ...
              <p className="meet-ishita-copy">
                ...
                conscious movement, sound therapy. Practices that do not just treat the body, but
                awaken it.
              </p>
              <p className="meet-ishita-copy">
              ...
              <p className="meet-ishita-copy">
                Not because I was exceptional. Because the body was always capable of this. It had
              ...
              <p className="meet-ishita-copy">
                That aliveness you are reaching for? It is not gone. It is buried under
              ...
              <p className="meet-ishita-signature">
                ...
                <span className="meet-ishita-signature-break">
                  If you are ready to feel alive again, let's talk.
                </span>
                <span className="meet-ishita-signature-break-strong">
                  The most powerful pharmacy you will ever need lives inside you. And I am here
