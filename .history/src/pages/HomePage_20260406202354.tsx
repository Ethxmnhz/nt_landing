              ...
              <AnimatedSection>
                <div className="hero-premium-inner">
                  ...
                  <h1 className="hero-premium-title">
                    Reset <span className="hero-highlight">&</span> Protect Your Energetic System Naturally
                  </h1>
                  ...
                  {/* Primary CTA */}
                  <div className="hero-premium-cta-wrapper">
                    <ButtonLink to="/book" className="hero-premium-btn">
                      Book Free Consultation
                      <ArrowRight size={18} style={{ marginLeft: 8 }} />
                    </ButtonLink>
                    <p className="hero-premium-cta-meta">
              ...
              <AnimatedSection delay={200}>
                <div className="hero-premium-image-container">
                  <div className="hero-image-placeholder">
                    <HandHeart size={64} strokeWidth={1.2} />
                    <p>Ishita's Healing Journey</p>
                  </div>
                  {/* Decorative elements */}
                  <div className="hero-visual-accent hero-visual-accent-1" />
                  <div className="hero-visual-accent hero-visual-accent-2" />
                </div>
              </AnimatedSection>
            </div>
          </div>
