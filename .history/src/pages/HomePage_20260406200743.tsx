    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="section-shell hero-content">
          ...
          <h1>Naturenergy</h1>
          <p className="hero-subtitle">Reset &amp; Protect Your Energetic System Naturally</p>
          <p className="doc-hero-meta">Recovery Alchemist, and Survivorship Voice</p>
          ...
          <div className="doc-glance-grid">
            <article className="doc-glance-card">
              <span className="service-icon">
                <ShieldPlus size={22} strokeWidth={1.9} />
              </span>
              <div>
                <h3>Reset</h3>
                <p>Protect and cleanse your energetic system.</p>
              </div>
            </article>
            <article className="doc-glance-card">
              <span className="service-icon">
              ...
              <div>
                <h3>Realign</h3>
                <p>Reconnect mind, body, and breath as one.</p>
              </div>
            </article>
            <article className="doc-glance-card">
              <span className="service-icon">
              ...
              <div>
                <h3>Rise</h3>
                <p>Live consciously with natural full energy.</p>
              </div>
            </article>
          </div>
        </div>
        ...
        <div className="section-shell">
          <AnimatedSection>
            <div className="section-intro centered">
              <p className="section-tag">Meet Ishita</p>
              <h2>Modern medicine gave me one perspective. Ancient Indian wisdom gave me another.</h2>
            </div>
          </AnimatedSection>
          <div className="doc-meet-grid">
            <AnimatedSection delay={80}>
              <article className="doc-story-card doc-story-card-lead">
                <p>
                  My healing demanded both. I was thrown ten feet across the road in a severe car
                  accident. When I regained consciousness, the world looked the same, but nothing
                  in my body felt like my own anymore.
                </p>
                <p>
                  The doctors were kind and honest. "Manage your expectations," they said. I heard
                  them. I chose a different story.
                </p>
                <p className="doc-story-quote">
                  Not because I was exceptional. Because the body was always capable of this.
                </p>
              </article>
            </AnimatedSection>
            <div className="doc-insight-stack">
              <AnimatedSection delay={140}>
                <article className="doc-insight-card">
                  <h3>The Turning Point</h3>
                  <p>
                    I turned to what modern medicine could not offer me: ancient breathwork,
                    conscious movement, sound therapy, and practices that awaken the body.
                  </p>
                </article>
              </AnimatedSection>
              ...
              <AnimatedSection delay={300}>
                <article className="doc-insight-card">
                  <h3>The Message</h3>
                  <p>
                    The body had not failed. It had simply been waiting to be remembered.
                  </p>
                </article>
              </AnimatedSection>
            </div>
