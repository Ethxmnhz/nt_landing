      ...
      <section className="section-light meet-ishita-section">
        <div className="section-shell">
          <div className="meet-ishita-split">
            ...
            <div className="meet-ishita-right">
              <AnimatedSection delay={120}>
                <article className="meet-note">
                  <p className="meet-note-hand">I heard them. I chose a different story.</p>
                  <p>
              ...
              <AnimatedSection delay={180}>
                <article className="meet-note">
                  <p className="meet-note-hand">The body holds more intelligence.</p>
                  <p>
              ...
              <AnimatedSection delay={240}>
                <article className="meet-note">
                  <p className="meet-note-hand">Ancient practices awakened me.</p>
                  <p>
                    I turned to ancient breathwork, conscious movement, and sound therapy.
                    Practices that do not just treat the body, but awaken it.
                  </p>
                </article>
              </AnimatedSection>
              <AnimatedSection delay={300}>
                <article className="meet-note meet-note-quote">
                  <p>
                    "Your body has not failed you. It has been waiting for you to come home."
                  </p>
                  <p className="meet-note-hand">If you are ready to feel alive again, let's talk.</p>
                </article>
              </AnimatedSection>
            </div>
          </div>
