    ...
    <>
      ...
      <section className="section-light meet-ishita-section">
        <div className="section-shell">
          <article className="meet-ishita-centered">
            <AnimatedSection delay={20}>
              <p className="meet-ishita-kicker">Meet Ishita</p>
            </AnimatedSection>
            ...
            <AnimatedSection delay={140}>
              <p className="meet-ishita-hook">
                Your body has not failed you. It has been waiting for you to come home.
              </p>
            </AnimatedSection>

            <div className="meet-ishita-rhythm">
              <AnimatedSection delay={190}>
                <section className="meet-ishita-block">
                  <h3>Story</h3>
                  <p>
                    I was thrown ten feet across the road in a severe car accident. When I
                    regained consciousness, the world looked the same. But nothing in my body felt
                    like my own anymore.
                  </p>
                  <p>
                    The doctors were kind and also honest. "Manage your expectations," they said.
                    I heard them. I chose a different story.
                  </p>
                </section>
              </AnimatedSection>
              ...
              <AnimatedSection delay={430}>
                <section className="meet-ishita-block">
                  <h3>Offer</h3>
                  <p>
                    If you are feeling lost right now, exhausted by pain, burnout, fear, or a
                    life that no longer feels like yours, I want you to know something.
                  </p>
                  <p>
                    That aliveness you are reaching for is not gone. It is buried under everything
                    you have been told to accept.
                  </p>
                  <p>
                    Today I work with professionals and individuals who are done shrinking, who
                    are ready to stop managing their limitations and start dismantling them.
            ...
            <AnimatedSection delay={500}>
              <p className="meet-ishita-signature">
                If you are ready to feel alive again, let us talk. The most powerful pharmacy you
                will ever need lives inside you. And I am here to help you unlock it.
              </p>
            </AnimatedSection>
