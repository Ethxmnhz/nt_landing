          ...
          <AnimatedSection>
            <article className="home-story-panel">
              <p className="home-story-copy">
                ...
                experience (NDE) where I was given the choice to return to my physical form or to
                continue into this new realm. I chose the former, and when I regained
                consciousness, my cancer began to heal.
              </p>
              <p className="home-story-copy">
                To the amazement of my doctors, I was free of countless tumors and cancer
                indicators within weeks. Since then, I have heeded the call to share this powerful
                story, and the lessons it revealed, with the world.
              </p>
              <p className="home-story-signature">
