      ...
      <section className="section-light meet-ishita-section">
        <div className="section-shell">
          <AnimatedSection delay={30}>
            <div className="section-intro centered meet-ishita-intro">
          ...
          <div className="meet-ishita-layout">
            <AnimatedSection delay={120}>
              <article className="meet-ishita-story">
                <p>
                ...
                <p className="meet-ishita-emphasis">
                  Not because I was exceptional. Because the body was always capable of this. It
            ...
            <AnimatedSection delay={210}>
              <article className="meet-ishita-manifesto">
                <p>
                ...
                <p className="meet-ishita-quote">
                  "Your body has not failed you. It has been waiting for you to come home."
                </p>
                <p className="meet-ishita-arrow">If you are ready to feel alive again, let us talk.</p>
                <p className="meet-ishita-quote-strong">
