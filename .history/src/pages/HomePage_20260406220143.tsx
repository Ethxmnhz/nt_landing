        ...
        <div className="section-shell">
          <AnimatedSection delay={80}>
            <article className="meet-ishita-centered">
              ...
              <p className="meet-ishita-copy">
                In 2006, after a four-year battle with cancer, I fell into a coma and was given
                hours to live. As my doctors gathered to revive me, I journeyed into a near-death
                experience where I was given the choice to return to my physical form or continue
                into a new realm. I chose to return, and when I regained consciousness, my body
                began to heal.
              </p>
              <p className="meet-ishita-copy">
                To the amazement of my doctors, I was free of countless tumors and cancer
                indicators within weeks. Since then, I have heeded the call to share this
                powerful story and its lessons with the world.
              </p>
              <p className="meet-ishita-signature">
                Love yourself fully. That is what you are here to do.
              </p>
