...
.heroImageOverlay {
  ...
  inset: 0;
  background:
    linear-gradient(90deg, rgba(2, 6, 23, 0.78) 0%, rgba(2, 6, 23, 0.38) 24%, rgba(2, 6, 23, 0.1) 58%, rgba(2, 6, 23, 0.05) 100%),
    linear-gradient(180deg, rgba(255, 255, 255, 0.03) 0%, transparent 18%, transparent 82%, rgba(255, 255, 255, 0.05) 100%);
}
            ...
            <AnimatedSection>
              <div className="heroPremiumInner">
                ...
                <h1 className="heroPremiumTitle">
                  Reset &amp; Protect Your
                  <span className="heroTitleBreak">Energetic System Naturally</span>
                </h1>
